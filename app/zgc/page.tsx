export default function Page() {
  return (
    <main className="max-w-3xl mx-auto px-5 py-12 prose">
      <div className="text-xs uppercase tracking-[0.18em] text-dim">benchmark</div>
      <h1>ZGC vs G1GC at 32 GB — real numbers</h1>

      <p className="text-dim text-lg">
        100-player Paper 1.21.1 server, identical hardware (AMD Ryzen 9 5950X, 64 GB DDR4,
        NVMe), week-long uptime, identical world + plugin loadout. Two collectors, same
        heap size. Here's what the numbers say.
      </p>

      <h2>Setup</h2>
      <ul>
        <li>Java 21.0.5 (Adoptium Temurin)</li>
      ...
      <table>
        <thead><tr><th>Metric</th><th>G1GC (Aikar)</th><th>ZGC generational</th></tr></thead>
        <tbody>
          <tr><td>Average TPS</td><td>19.6</td><td><strong>19.9</strong></td></tr>
          <tr><td>1 % low TPS</td><td>15.2</td><td><strong>18.7</strong></td></tr>
          <tr><td>Max GC pause</td><td>312 ms</td><td><strong>3 ms</strong></td></tr>
          <tr><td>Avg GC pause</td><td>87 ms</td><td><strong>0.8 ms</strong></td></tr>
          <tr><td>GC time (% of CPU)</td><td>4.2 %</td><td>2.9 %</td></tr>
          <tr><td>Total RAM (RSS)</td><td>32.4 GB</td><td>33.1 GB</td></tr>
